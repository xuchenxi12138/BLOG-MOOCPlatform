...
export default {
    ...
    methods: {
        ...
        close() {
            this.$store.state.blogCreatorVisible = false;
        },
        ...
        submit() {
            ...
            if (blog['title']) {
                ...
                blog['identification'] = this.identification
                let formData = new FormData()
                formData.append("title", blog['title'])
                formData.append("owner_id", blog['owner_id'])
                ...
                axios.post(server + "/blog/post", formData)
                    .then(() => {
                        this.$message({
                            message: "上传成功",
                            type: 'success'
